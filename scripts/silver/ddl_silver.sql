...
Purpose:
    ...
    tables first if they already exist.

    Run this script to re-define the DDL structure of the 'silver' tables.

Sources:
    - CRM system: customer info, product info, and sales transaction details.
    - ERP system: customer demographics, customer location, and product
